...
public class ChangePasswordCurrentMissing {
  ...
  @Test
  public void testChangePasswordCurrentMissing() throws Exception {
    ...
    assertTrue(isElementPresent(By.id("OldPassword-error")));
    driver.findElement(By.xpath("//button[@type='submit']")).click();
  }
